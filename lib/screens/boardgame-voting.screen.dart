  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Obx(() {
          if (boardgameCtrl.availableBoardgames.isEmpty &&
              boardgameCtrl.chosenBoardgames.isEmpty) {
            return Center(
              child: Text(
                tr('boardgameVoting.noItemsFound'),
              ...
              children: [
                ...
                Expanded(
                  child: DragTarget<Scheduling>(
                    onAcceptWithDetails:
                        (DragTargetDetails<Scheduling> details) {
                          ...
                          child: ReorderableListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return Container(
                                ...
                                margin: EdgeInsets.fromLTRB(8, 0, 24, 4),
                                height: 40, // Add this line to set the height
                                child: Padding(
                                  padding: EdgeInsets.fromLTRB(16, 0, 0, 0),
                                  child: Row(
                                    children: [
